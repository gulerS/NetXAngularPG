...
namespace NetXAngularPG.Application.Features.Queries.ProductImageFile.GetProductImages
{
    public class GetProductImagesQueryHandler : IRequestHandler<GetProductImagesQueryRequest, List<GetProductImagesQueryResponse>>
    {
        ...
        public GetProductImagesQueryHandler(IProductQueryRepository productQueryRepository, IConfiguration configuration)
        {
